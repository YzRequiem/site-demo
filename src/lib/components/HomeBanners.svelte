		...
		<div class="p-8 flex items-center">
			<div class="mx-auto max-w-xl text-center sm:text-left flex flex-col gap-5">
				<div class="flex items-center justify-center gap-3 md:justify-start">
					...
					<h1 class="text-3xl font-bold text-gray-900 md:text-3xl dark:text-slate-100">
						SilverStock
					</h1>
				</div>
				...
				<p class="hidden text-gray-500 dark:text-gray-300 md:mt-4 md:block">
					...
					outils innovants qui vous ouvrent les possibles.
				</p>

				<div class="mt-4 md:mt-8">
					<a
						href="#"
						class="inline-block rounded bg-[#BE0562] px-12 py-3 text-sm font-medium text-white transition hover:bg-[#23B7E5] focus:outline-none focus:ring focus:ring-yellow-400"
					>
